...
#Connect to Database
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://dam_oze7_user:OaKrhuokUul1zuCDxuXUcQv5s57UK4P7@dpg-cnsmiimd3nmc73apihlg-a.oregon-postgres.render.com/dam_oze7'
